...
var style_JODarjo_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("-Jumlah Pe");
    ...
    if (value >= 0.000000 && value <= 665.600000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 665.600000 && value <= 1331.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1331.200000 && value <= 1996.800000) {
            style = [ new ol.style.Style({
