...
map.getView().fit([12493944.657646, -863842.375875, 12622768.190271, -804088.032015], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Data Kabupaten Sidoarjo</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (82 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '1. Badan Pusat Statistik Kabupaten Sidoarjo<br />2. Ina Geo-Portan Tanah Air Indonesia ';
            }
